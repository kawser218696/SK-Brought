...
GHT = '''
        ...
        +---------------------------------------+
        |#Author:MD KAWSER MHAMUD    |
        |#Contact:https://www.facebook.com/SK.TEAM.THE.LEGEND.OF.VERTUAL/|
        |#Contributos: SK BROTHER'S Jimenez      |
        |#contributor contact:KAWSER |
        | https://github.com/kawser218696|
        |   https://twitter.com/kawser218696   |
        |                                       |
        |#Date: 02/02/2021                      |
        |#Update at: 21/02/2021                 |
