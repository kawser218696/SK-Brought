...
GHT = '''
        ...
        |#Author: SK BROTHER'S OFFICIAL|

        |#Contact: www.fb.com/mauritanie.forever|

        |#Contributos: SK BROTHER'S BLACK      |

        |#contributor contact:    https://www.facebook.com/SK.TEAM.THE.LEGEND.OF.VERTUAL/              |
